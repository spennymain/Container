...
int setup_child_capabilities()
{
    ...
    for(int i=0; i<num_caps_to_drop; i++) {
...
int setup_syscall_filters()
{
    ...
    if(!seccomp_ctx){
        fprintf(stderr,"seccomp intialization failed: %m\n");
        return EXIT_FAILURE;
    }
    //for move_pages
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'move_pages':%m\n");
        return EXIT_FAILURE;
    }
    //for ptrace
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'ptrace':%m\n");
        return EXIT_FAILURE;
    }
    //for mbind
    filter_set_status = seccomp_rule_add(     
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'mbind':%m\n");
        return EXIT_FAILURE;
    }
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'migrate_pages':%m\n");
        return EXIT_FAILURE;
    }
    //for unshare
    filter_set_status = seccomp_rule_add(
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'unshare':%m\n");
        return EXIT_FAILURE;
    }
    //for clone
    filter_set_status = seccomp_rule_add(
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'clone':%m\n");
        return EXIT_FAILURE;
    }
    //for chmod we need 2 seccomp rules
    filter_set_status = seccomp_rule_add(       
                                                seccomp_ctx,
                                                SCMP_FAIL,
                                                SCMP_SYS(chmod),
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'chmod':%m\n");
        return EXIT_FAILURE;
    }
    ...
    filter_set_status = seccomp_rule_add(       
                                                ...
                                                SCMP_SYS(chmod),
                                                1,
                                                SCMP_A0(SCMP_CMP_MASKED_EQ, S_ISGID, S_ISGID)
                                            );
    if(filter_set_status){
        if(seccomp_ctx){
            seccomp_release(seccomp_ctx);
    ...
    if(filter_set_status){
        ...
        fprintf(stderr,"seccomp could add KILL rule for 'SCMP_FLTATR_CTL_NNP':%m\n");
        return EXIT_FAILURE;
    }
